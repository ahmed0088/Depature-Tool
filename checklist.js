...
function clRender2() {
  ...
  const totalActive = CL_STEPS.filter(s => !clState.skipped.has(s.id)).length;
  const doneActive  = CL_STEPS.filter(s => !clState.skipped.has(s.id) && clState.done.has(s.id)).length;
